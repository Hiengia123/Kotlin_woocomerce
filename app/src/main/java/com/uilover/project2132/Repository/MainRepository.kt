package com.uilover.project2132.Repository
...
class MainRepository {
    ...
    fun loadBanner(): LiveData<MutableList<SliderModel>> {
        ...
        val ref = firebaseDatabase.getReference("banners")  // Changed from "Banner" to "banners"
    ...
    fun loadCategory(): LiveData<MutableList<CategoryModel>> {
        ...
        val ref = firebaseDatabase.getReference("categories")  // Changed from "Category" to "categories"
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (childSnapshot in snapshot.children) {
                    ...
                    item?.let {
                        it.id = childSnapshot.key ?: ""  // Set id from Firebase key
                        lists.add(it)
                    }
                }
                listData.value = lists
    ...
    fun loadPopular(): LiveData<MutableList<ItemsModel>> {
        ...
        val ref = firebaseDatabase.getReference("items")  // Changed from "Items" to "items"
        val query: Query = ref.orderByChild("showRecommend").equalTo(true)  // Changed from "showRecommended" to "showRecommend"
